...
namespace Instride\Bundle\OpenDxpElementManagerBundle\DependencyInjection\CompilerPass;

use Instride\Bundle\OpenDxpElementManagerBundle\DuplicateIndex\DataTransformer\ContainerDataTransformerFactory;
...
class AddDataTransformersPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $dataTransformers = [];
        $services = $container->findTaggedServiceIds('opendxp_element_manager.data_transformer', true);
